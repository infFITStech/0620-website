<template>
  ...
  <div class=" dir-ltr">
    <div
      ref="headerRef"
      class="lg:flex hidden bg-white dark:bg-gray-900 w-full lg:h-[70px] items-center transition-all duration-500 transform overflow-hidden"
    >
      <div class="container lg:px-4 px-2 max-h-full h-full">
